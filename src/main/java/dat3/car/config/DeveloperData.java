...
public class DeveloperData implements ApplicationRunner {
  ...
  public void run(ApplicationArguments args) throws Exception {
    List<Member> members = MemberTestDataFactory.generateTestMembers("test12", 4);
    ...
    System.out.println("Should NOT find: " + reservationRepository.existsByCar_IdAndRentalDate(car1.getId(), date1.plusDays(5)));
  }
